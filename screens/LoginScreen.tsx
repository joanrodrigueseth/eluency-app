...
export default function LoginScreen() {
  ...
  const logoW = Math.min(317, screenWidth - 36);
    ...
    >
      ...
      >
        <View style={{ flex: 1, justifyContent: "flex-start" }}>
          ...
          <View
            style={{ alignItems: "center", marginBottom: 1, marginTop: 8 }}
            pointerEvents="box-none"
          >
            <View style={{ overflow: "visible", marginBottom: -40 }}>
              <Image source={theme.isDark ? LOGO_DARK_SRC : LOGO_SRC} style={{ width: logoW, height: logoH }} resizeMode="contain" />
            </View>

            <Text
              style={[
                theme.typography.display,
                { marginTop: 4, textAlign: "center", fontSize: 30, lineHeight: 36, zIndex: 1 },
              ]}
            >
