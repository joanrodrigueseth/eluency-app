...
export default function RegisterScreen() {
  ...
  const logoW = Math.min(270, screenWidth - 64);
  const logoH = Math.round(logoW * (169 / 300));
  const landingHighlights = [
    {
      icon: "book-open" as const,
      title: "100+ ready-made lessons",
      description: "Vocabulary-first content across multiple languages, structured and ready to assign.",
      iconBg: theme.isDark ? "rgba(96,165,250,0.16)" : "#E8F1FB",
      iconColor: theme.colors.primary,
    },
    {
      icon: "users" as const,
      title: "Built for real classrooms",
      description: "Track progress, assign work, and give feedback from one clean dashboard.",
      iconBg: theme.isDark ? "rgba(52,211,153,0.18)" : "#E8F8F2",
      iconColor: theme.colors.success,
    },
    {
      icon: "star" as const,
      title: "Students actually enjoy it",
      description: "Game-based vocabulary practice keeps learners engaged and coming back.",
      iconBg: theme.isDark ? "rgba(243,198,77,0.16)" : "#FFF3E8",
      iconColor: theme.colors.violet,
    },
  ] as const;
  const trustTeachers = [
    { letter: "M", bg: theme.colors.primary },
    { letter: "J", bg: theme.colors.success },
    { letter: "A", bg: "#BA7517" },
  ] as const;
  ...
  if (step === 0) {
    return (
      <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
        ...
        >
            <View style={{ overflow: "visible", marginTop: -12, marginBottom: -4 }}>
              <Image
                source={theme.isDark ? LOGO_DARK_SRC : LOGO_SRC}
          ...
          >
            <View
              ...
              style={{
                ...
                borderRadius: 999,
                backgroundColor: theme.colors.primarySoft,
                opacity: theme.isDark ? 0.55 : 0.85,
              }}
            />
            <View
              pointerEvents="none"
              style={{
                ...
                borderRadius: 999,
                backgroundColor: theme.colors.violetSoft,
                opacity: theme.isDark ? 0.45 : 0.75,
              }}
            />
            ...
            <View
              style={{
                ...
                paddingTop: 18,
                paddingBottom: 16,
                backgroundColor: theme.isDark ? "rgba(15,23,32,0.22)" : "rgba(255,255,255,0.42)",
              }}
            >
              <Text style={[theme.typography.label, { color: theme.colors.primary, textAlign: "center" }]}>
                Why teachers choose Eluency
              </Text>
              ...
              <View
                style={{
                  ...
                  backgroundColor: theme.isDark ? "rgba(17,24,39,0.56)" : "rgba(255,255,255,0.58)",
              ...
              >
                {landingHighlights.map((item, index) => (
                  <View key={item.title}>
                    ...
                    {index < landingHighlights.length - 1 ? (
                      <View
                        style={{
                          height: 1,
                          backgroundColor: theme.isDark ? "rgba(255,255,255,0.07)" : "rgba(0,0,0,0.06)",
                        }}
                      />
                    ) : null}
                  </View>
                ...
                >
                  <View style={{ flexDirection: "row", paddingLeft: 6 }}>
                    {trustTeachers.map((teacher, index) => (
                      <View
                        key={teacher.letter}
                        style={{
                          width: 24,
                          ...
                          alignItems: "center",
                          justifyContent: "center",
                          zIndex: trustTeachers.length - index,
                        }}
                      >
                        <Text style={{ color: "#FFFFFF", fontSize: 10, fontWeight: "700" }}>{teacher.letter}</Text>
                      </View>
                    ))}
                  </View>

                  <View style={{ flex: 1 }}>
                    <Text style={[theme.typography.caption, { color: theme.colors.text, fontSize: 11, lineHeight: 14 }]}>
                      Trusted by 1,000+ teachers
                    </Text>
                    <View style={{ flexDirection: "row", alignItems: "center", gap: 5, marginTop: 2 }}>
                      <Text style={{ color: "#D38A1C", fontSize: 10, lineHeight: 12 }}>★★★★★</Text>
                      <Text style={[theme.typography.caption, { fontSize: 10, lineHeight: 12, color: theme.colors.textMuted }]}>
                        4.9/5
                      </Text>
                    </View>
                  </View>
